...
export default function ExpenseDetailScreen() {
  ...
  function handleDelete() {
    Alert.alert('Delete expense?', `This removes "${expense!.title}" and updates everyone's balance.`, [
  ...
  return (
    <Screen hasHeader contentStyle={{ paddingBottom: insets.bottom + spacing.xl, gap: spacing.lg }}>
        ...
        <View style={{ flexDirection: 'row', justifyContent: 'space-between', alignItems: 'flex-start' }}>
          ...
          <View style={{ alignItems: 'flex-end', gap: 4 }}>
            {expense.splitBetween.map((personId) => {
              ...
              return (
                <View key={personId} style={{ flexDirection: 'row', alignItems: 'center', gap: spacing.xs }}>
      ...
      <View style={{ flexDirection: 'row', gap: spacing.md }}>
        ...
        <Button label="Delete" variant="danger" onPress={handleDelete} style={{ flex: 1 }} />
      </View>
    </Screen>
  );
}
